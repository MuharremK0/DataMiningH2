...
# gerekli kolonlar
df = df[["AcademicRecordID", "JournalName", "abstract_clean", "title_clean", "text_for_model"]].dropna().copy()

# az örnekli dergileri filtrele
...
results.append(
    evaluate_representation(
        train_texts=train_df["abstract_clean"],
        test_texts=test_df["abstract_clean"],
        train_labels=train_df["JournalName"],
        test_labels=test_df["JournalName"],
        exp_name="abstract_only"
    )
)
...
results.append(
    evaluate_representation(
        train_texts=train_df["text_for_model"],
        test_texts=test_df["text_for_model"],
        train_labels=train_df["JournalName"],
        test_labels=test_df["JournalName"],
